...
type RouteFiles = {
  "root.tsx": {
    id: "root";
    page: "/" | "/*" | "/admin/cache" | "/admin/cache/lru/:cacheKey" | "/admin/cache/sqlite" | "/admin/cache/sqlite/:cacheKey" | "/me" | "/resources/download-user-data" | "/resources/healthcheck" | "/resources/note-images/:imageId" | "/resources/user-images/:imageId" | "/settings/profile" | "/settings/profile/change-email" | "/settings/profile/connections" | "/settings/profile/password" | "/settings/profile/password/create" | "/settings/profile/photo" | "/settings/profile/two-factor" | "/settings/profile/two-factor/disable" | "/settings/profile/two-factor/verify" | "/users/:username" | "/users/:username/notes" | "/users/:username/notes/:noteId" | "/users/:username/notes/:noteId/edit" | "/users/:username/notes/new" | "/users" | "/auth/:provider" | "/auth/:provider/callback" | "/forgot-password" | "/login" | "/logout" | "/onboarding" | "/onboarding/:provider" | "/reset-password" | "/signup" | "/verify" | "/robots.txt" | "/sitemap.xml";
  };
  "routes/$.tsx": {
    id: "routes/$";
    page: "/*";
  ...
  "routes/resources+/note-images.$imageId.tsx": {
    ...
    page: "/resources/note-images/:imageId";
  };
  "routes/resources+/user-images.$imageId.tsx": {
    id: "routes/resources+/user-images.$imageId";
    page: "/resources/user-images/:imageId";
  };
  "routes/settings+/profile.tsx": {
    id: "routes/settings+/profile";
    page: "/settings/profile" | "/settings/profile/change-email" | "/settings/profile/connections" | "/settings/profile/password" | "/settings/profile/password/create" | "/settings/profile/photo" | "/settings/profile/two-factor" | "/settings/profile/two-factor/disable" | "/settings/profile/two-factor/verify";
  };
  ...
  "routes/_auth+/auth.$provider.ts": {
    ...
    page: "/auth/:provider" | "/auth/:provider/callback";
  };
